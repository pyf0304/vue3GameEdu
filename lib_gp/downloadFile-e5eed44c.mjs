...
import { _ as s } from "./index-72dceb29.mjs";
const u = r({
  name: "DownloadFile",
  setup() {
    function n() {
      const t = "http://localhost:8094/gameEdu/UploadFiles/PaperUploadFile/设计思维理念下的STEM课程设计...院REDlab STEM课程为例_吴昭20220107033454.pdf", l = "文件名.pdf";
