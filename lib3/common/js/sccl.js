...
function closePage() {
    ...
    if ($(this).parents(".content-tab").hasClass("active")) {
        //if ($(this).parents(".content-tab").next(".content-tab").size()) {//潘以锋20190422
        if ($(this).parents(".content-tab").next(".content-tab").length > 0) {
        ...
        //        if ($(this).parents(".content-tab").prev(".content-tab").size()) {////潘以锋20190422
        if ($(this).parents(".content-tab").prev(".content-tab").length > 0) {
