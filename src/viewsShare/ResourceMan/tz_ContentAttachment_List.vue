        ...
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('resourceTypeName')">
              资源类型名称
              <span v-if="sortColumnKey === 'resourceTypeName'">
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.resourceTypeName"></td>

            <td v-html="item.fileName"></td>

            <td v-html="item.extension"></td>

            <td v-html="item.filePath"></td>

            <td v-html="item.courseName"></td>

            <td v-html="item.uploadDate"></td>

            <td v-html="item.uploadPerson"></td>
