 ...
 * @returns 条件串(strWhereCond)
 **/
export const Combinetz_ContentAttachmentConditionObj=async (): Promise<clstz_ContentAttachmentEN> =>
{
//使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
//例如 1 = 1 && UserName = '张三'
 ...
 * @returns 条件串(strWhereCond)
 **/
export const Combinetz_ContentAttachmentConditionObj4ExportExcel = async ():Promise<clstz_ContentAttachmentEN> => 
{
//使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
//例如 1 = 1 && UserName = '张三'
