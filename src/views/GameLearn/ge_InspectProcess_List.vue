      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('operationTypeName')">
              操作类型名
              <span v-if="sortColumnKey === 'operationTypeName'">
                <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
              </span>
            </th>
            ...
            <th @click="sortColumn('controlTypeName')">
              控件名称
              <span v-if="sortColumnKey === 'controlTypeName'">
                <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
              </span>
            </th>

            <th @click="sortColumn('controlAttributeName')">
              属性名称
              <span v-if="sortColumnKey === 'controlAttributeName'">
                <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
              </span>
            </th>
            ...
            <th @click="sortColumn('checkMemo')">
              检查描述
              <span v-if="sortColumnKey === 'checkMemo'">
                <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
              </span>
            </th>
            ...
            <th @click="sortColumn('eventTypeName')">
              事件名称
              <span v-if="sortColumnKey === 'eventTypeName'">
                <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
              </span>
            </th>
            ...
            <th @click="sortColumn('typeDescribe')">
              类型描述
              <span v-if="sortColumnKey === 'typeDescribe'">
                <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
              </span>
            </th>
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.operationTypeId"></td>

            <td v-html="item.controlId"></td>

            <td v-html="item.controlTypeId"></td>

            <td v-html="item.attributeId"></td>

            <td v-html="item.controlValue"></td>

            <td v-html="item.checkMemo"></td>

            <td v-html="item.controlClass"></td>

            <td v-html="item.eventTypeId"></td>

            <td v-html="item.functionName"></td>

            <td v-html="item.examinationTypeId"></td>
