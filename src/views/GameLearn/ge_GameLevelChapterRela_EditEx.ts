/**
 * 类名:ge_GameLevelChapterRela_EditEx(界面:ge_GameLevelChapterRelaCRUD)
 * 表名:ge_GameLevelChapterRela(01120913)
 * 版本:2024.01.29.1(服务器:WIN-SRV103-116)
 * 日期:2024/02/01 13:16:06
 * 生成者:
 工程名称:问卷调查(0112)
...
/* ge_GameLevelChapterRela_EditEx 的摘要说明。其中Q代表查询,U代表修改
  (AutoGCLib.Vue_ViewScript_EditCSEx_TS4TypeScript:GeneCode)
*/
export class ge_GameLevelChapterRela_EditEx extends ge_GameLevelChapterRela_Edit {
  /**
 ...
 **/
  public static btnEdit_Click(strCommandName: string, strKeyId: string) {
    ...
    const objPage: ge_GameLevelChapterRela_EditEx = <ge_GameLevelChapterRela_EditEx>(
      ge_GameLevelChapterRela_Edit.GetPageEditObj('ge_GameLevelChapterRela_EditEx')
    );
    if (objPage == null) {
      const strMsg = `从预存编辑类获取关键字:[ge_GameLevelChapterRela_EditEx]的对象为空，请在调用编辑类(父类)的定义一下！`;
