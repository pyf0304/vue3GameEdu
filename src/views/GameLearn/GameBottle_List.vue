      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('bottleId')">
              瓶子Id
              <span>
                <i
                  :class="
                    sortColumnKey === 'bottleId'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('questionTypeName|Ex')">
              题目类型名
              <span>
                <i
                  :class="
                    sortColumnKey === 'questionTypeName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('userId_Throw')">
              用户ID
              <span>
                <i
                  :class="
                    sortColumnKey === 'userId_Throw'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('userName_Throw|Ex')">
              用户名_扔
              <span>
                <i
                  :class="
                    sortColumnKey === 'userName_Throw|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('throwTime')">
              扔的时间
              <span>
                <i
                  :class="
                    sortColumnKey === 'throwTime'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('userId_PickUp')">
              用户ID
              <span>
                <i
                  :class="
                    sortColumnKey === 'userId_PickUp'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('userName_PickUp|Ex')">
              用户名_捞
              <span>
                <i
                  :class="
                    sortColumnKey === 'userName_PickUp|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('pickUpTime')">
              捞的时间
              <span>
                <i
                  :class="
                    sortColumnKey === 'pickUpTime'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('finishedTime')">
              完成时间
              <span>
                <i
                  :class="
                    sortColumnKey === 'finishedTime'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.bottleId"></td>

            <td v-html="item.questionTypeName"></td>

            <td v-html="item.questionName"></td>

            <td v-html="item.userId_Throw"></td>

            <td v-html="item.userName_Throw"></td>

            <td v-html="item.throwTime"></td>

            <td v-html="item.userId_PickUp"></td>

            <td v-html="item.userName_PickUp"></td>

            <td v-html="item.pickUpTime"></td>

            <td v-html="item.finishedTime"></td>
          </tr> </tbody
      ></table>
    </template>
  </div>
