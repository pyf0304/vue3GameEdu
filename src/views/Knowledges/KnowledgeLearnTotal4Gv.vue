      ...
      <table>
        <tbody>
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.learnCount"></td>

            <td v-html="item.successCount"></td>

            <td v-html="item.failCount"></td>

            <td v-html="item.continuousSuccessCount"></td>

            <td v-html="item.continuousFailCount"></td>

            <td v-html="item.lastLearnDate"></td>

            <td v-html="item.recommendedNextReviewDate"></td>
