      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('learnModeName|Ex')">
              学习模式
              <span>
                <i
                  :class="
                    sortColumnKey === 'learnModeName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('caseTypeName|Ex')">
              案例类型
              <span>
                <i
                  :class="
                    sortColumnKey === 'caseTypeName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
