      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('knowledgeGraphName')">
              连连看图名
              <span v-if="sortColumnKey === 'knowledgeGraphName'">
                <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
              </span>
            </th>

            <th @click="sortColumn('relaTypeName')">
              关系类型名
              <span v-if="sortColumnKey === 'relaTypeName'">
                <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
              </span>
            </th>
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.courseKnowledgeIdA"></td>

            <td v-html="item.courseKnowledgeIdB"></td>
