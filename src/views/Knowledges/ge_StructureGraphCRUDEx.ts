...
*/
export class ge_StructureGraphCRUDEx extends ge_StructureGraphCRUD implements IShowList {
  public static vuebtn_Click: (strCommandName: string, strKeyId: any) => void;
  public static GetPropValue: (strPropName: string) => string;
  //public static divName4List: string = "divDataLst";
  //public static mstrSortge_StructureGraphBy: string = "structureGraphId";
  /*
   * 每页记录数，在扩展类可以修改
   */
  ...
  BindGvCache(strType: string) {
    switch (strType) {
      case 'ge_StructureGraph':
        alert('该类没有绑定该函数：[this.BindGv_ge_StructureGraph4Func]！');
        //this.BindGv_ge_StructureGraph4Func(divVarSet.refDivList);
        break;
      default:
 ...
 */
  public static btn_Click(strCommandName: string, strKeyId: string) {
    const objPage: ge_StructureGraphCRUDEx = new ge_StructureGraphCRUDEx();
