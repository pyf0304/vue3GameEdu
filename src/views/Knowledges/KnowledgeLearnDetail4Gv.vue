        ...
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('knowledgeName')">
              课程知识点
              <span v-if="sortColumnKey === 'knowledgeName'">
                <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
              </span>
            </th>

            <th @click="sortColumn('learnModeName')">
              学习模式
              <span v-if="sortColumnKey === 'learnModeName'">
                <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
              </span>
            </th>
            ...
            <th @click="sortColumn('caseTypeName')">
              案例类型
              <span v-if="sortColumnKey === 'caseTypeName'">
                <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
              </span>
            </th>
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.learnDate"></td>

            <td v-html="item.caseTypeName"></td>

            <td v-html="item.isRight"></td>

            <td v-html="item.isMaster"></td>

            <td v-html="item.masterDegree"></td>

            <td v-html="item.markTime"></td>

            <td v-html="item.isAnalysis"></td>
