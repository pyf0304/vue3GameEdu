...
import { refLearnMode_Edit, divVarSet, viewVarSet } from '@/views/CourseLearning/LearnModeVueShare';
import { Format } from '@/ts/PubFun/clsString';
/** LearnModeCRUDEx 的摘要说明。其中Q代表查询,U代表修改
 * (AutoGCLib.Vue_ViewScriptCSEx_TS4TypeScript:GeneCode)
 **/
export class LearnModeCRUDEx extends LearnModeCRUD implements IShowList {
