      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('upMenuName')">
              上级菜单名
              <span v-if="sortColumnKey === 'upMenuName'">
                <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
              </span>
            </th>
            ...
            <th @click="sortColumn('roleNames')">
              相关角色
              <span v-if="sortColumnKey === 'roleNames'">
                <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
              </span>
            </th>
            ...
            <th @click="sortColumn('dateTimeSim')">
              日期
