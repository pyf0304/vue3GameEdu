        ...
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('orderNum')">
              排序号
              <span v-if="sortColumnKey === 'orderNum'">
            ...
            <th @click="sortColumn('menuName')">
              菜单名
              <span v-if="sortColumnKey === 'menuName'">
                <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
              </span>
            </th>

            <th @click="sortColumn('menuSetId')">
              菜单集Id
              <span v-if="sortColumnKey === 'menuSetId'">
                <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
              </span>
            </th>

            <th @click="sortColumn('menuSetName')">
              菜单集名称
              <span v-if="sortColumnKey === 'menuSetName'">
                <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
              </span>
            </th>

            <th @click="sortColumn('isLeafNode')">
              是否叶子
              <span v-if="sortColumnKey === 'isLeafNode'">
                <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
              </span>
            </th>

            <th @click="sortColumn('pageDispModeId')">
              页面显示模式Id
              <span v-if="sortColumnKey === 'pageDispModeId'">
                <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
              </span>
            </th>

            <th @click="sortColumn('inUse')">
              是否在用
              <span v-if="sortColumnKey === 'inUse'">
                <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
              </span>
            </th>

            <th @click="sortColumn('upMenuId')">
              上级菜单Id
              <span v-if="sortColumnKey === 'upMenuId'">
                <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
              </span>
            </th>
