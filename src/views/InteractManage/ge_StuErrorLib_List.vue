      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('sourceTypeName')">
              来源类型名称
              <span v-if="sortColumnKey === 'sourceTypeName'">
                <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
              </span>
            </th>
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.creator"></td>

            <td v-html="item.createDate"></td>

            <td v-html="item.redoDate"></td>
            ...
            <td v-html="item.sourceTypeName"></td>

            <td v-html="item.isRedo"></td>

            <td v-html="item.isPassed"></td>
