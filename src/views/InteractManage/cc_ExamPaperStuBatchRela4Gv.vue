        ...
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('stuName')">
              学生
              <span v-if="sortColumnKey === 'stuName'">
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.batchTime"></td>

            <td v-html="item.eduClsName"></td>

            <td v-html="item.scores"></td>

            <td v-html="item.isSave"></td>
            ...
            <td v-html="item.answerIP"></td>

            <td v-html="item.answerDate"></td>

            <td v-html="item.answerTime"></td>

            <td v-html="item.totalGetScore"></td>
...
<script lang="ts">
  ...
  export default defineComponent({
    name: 'CcExamPaperStuBatchRela4Gv',
    components: {
      // 组件注册
    },
