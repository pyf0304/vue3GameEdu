...
import { divVarSet, viewVarSet } from '@/views/GameLearn/ge_ExaminationCriteriaVueShare';
...
export default class PassGameEx extends ge_UserCreditsLogCRUD implements IShowList {
  public static vuebtn_Click: (strCommandName: string, strKeyId: any) => void;
  public static GetPropValue: (strPropName: string) => string;
  public static divList_Cls: HTMLDivElement; //列表区的层对象
  public static intQuestioned = 0; //数组考题编号

  public static objPageCRUD: PassGameEx;
  ...
  public get examBatchNo() {
    const strExamBatchNo = PassGameEx.GetPropValue('examBatchNo');
    return strExamBatchNo;
  }
  public set examBatchNo(value) {
    PassGameEx.vuebtn_Click('SetExamBatchNo', value);
  }
  ...
  */
  public static btn_Click(strCommandName: string, strKeyId: string) {
    const objPage: PassGameEx = new PassGameEx();
  ...
  public async PageLoad() {
    ...
    try {
      //PassGameEx.strid_CurrEduClsCache = clsPubLocalStorage.idCurrEduCls;
  ...
  */
  ...
  public get questionTypeId_q() {
    const strQuestionTypeId_q = PassGameEx.GetPropValue('questionTypeId_q');
  ...
  public async SortColumn(sortColumnKey: string, sortDirection: string) {
    ...
    // await this.BindGv_vgs_TeachingDateCache(divVarSet.refDivList);
  }
}
