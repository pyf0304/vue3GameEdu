      ...
      <table>
        <tbody>
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.paperTitle"></td>

            <td v-html="item.researchQuestion"></td>

            <td v-html="item.keyword"></td>

            <td v-html="item.literatureSources"></td>

            <td v-html="item.literatureLink"></td>

            <td v-html="item.uploadfileUrl"></td>

            <td v-html="item.isQuotethesis"></td>

            <td v-html="item.checker"></td>

            <td v-html="item.isChecked"></td>
...
<script lang="ts">
  ...
  export default defineComponent({
    name: 'VMajorDirectionPaperRelaList',
    components: {
      // 组件注册
    },
