      ...
      <table>
        <tbody>
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.paperRWId"></td>

            <td v-html="item.subViewpointTypeName"></td>

            <td v-html="item.rWTitle"></td>

            <td v-html="item.subViewpointContent"></td>

            <td v-html="item.explainTypeName"></td>

            <td v-html="item.isPublic"></td>
