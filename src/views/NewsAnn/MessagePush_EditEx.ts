 ...
 /**
 * 类名:MessagePush_EditEx(界面:MessagePushCRUD,01120240)
 * 表名:MessagePush(01120280)
 * 版本:2024.12.07.1(服务器:WIN-SRV103-116)
 * 日期:2024/12/12 13:50:18
 * 生成者:
 工程名称:问卷调查(0112)
...
*/
export default class  MessagePush_EditEx extends MessagePush_Edit
{
...
if (objPage == null)
{
const strMsg = `从预存编辑类获取关键字:[MessagePush_EditEx]的对象为空，请在调用编辑类(父类)的定义一下！`;
