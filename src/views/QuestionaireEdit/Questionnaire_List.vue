      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('chapterName|Ex')">
              章名
              <span>
                <i
                  :class="
                    sortColumnKey === 'chapterName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('levelModeTypeName|Ex')">
              模式名
              <span>
                <i
                  :class="
                    sortColumnKey === 'levelModeTypeName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
