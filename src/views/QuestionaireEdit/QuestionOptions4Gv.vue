      ...
      <table>
        <tbody>
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.optionName"></td>

            <td v-html="item.optionIndex"></td>

            <td v-html="item.optionTitle"></td>

            <td v-html="item.optionContent"></td>

            <td v-html="item.isCorrect"></td>

            <td v-html="item.score"></td>
