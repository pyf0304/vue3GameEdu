      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('questionNo')">
              题目编号
              <span v-if="sortColumnKey === 'questionNo'">
            ...
            <th @click="sortColumn('chapterName')">
              章名
              <span v-if="sortColumnKey === 'chapterName'">
                <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
              </span>
            </th>
            ...
            <th @click="sortColumn('difficultyLevelName')">
              难度等级名称
              <span v-if="sortColumnKey === 'difficultyLevelName'">
                <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
              </span>
            </th>

            <th @click="sortColumn('levelModeTypeName')">
              模式名
              <span v-if="sortColumnKey === 'levelModeTypeName'">
                <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
              </span>
            </th>
            ...
            <th @click="sortColumn('updUser')">
              修改人
              <span v-if="sortColumnKey === 'updUser'">
                <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
              </span>
            </th>
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.levelModeTypeName"></td>

            <td v-html="item.levelNo"></td>
            ...
            <td v-html="item.isJs"></td>

            <td v-html="item.isTest"></td>
          </tr> </tbody
      ></table>
    </template>
  </div>
