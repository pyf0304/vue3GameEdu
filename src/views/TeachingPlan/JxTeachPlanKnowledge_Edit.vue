...
<script lang="ts">
  ...
  */
       ...
       **/
      async function GetEditDataJxTeachPlanKnowledgeObj() {
        const pobjJxTeachPlanKnowledgeEN = new clsJxTeachPlanKnowledgeEN();
        ...
        pobjJxTeachPlanKnowledgeEN.SetUpdDate(clsDateTime.getTodayDateTimeStr(1)); // 修改日期
       ...
       **/
      async function ShowDataFromJxTeachPlanKnowledgeObj(
      ...
      return {
        ...
        strSubmitButtonText,
        strCancelButtonText,
        GetEditDataJxTeachPlanKnowledgeObj,
        ShowDataFromJxTeachPlanKnowledgeObj,
