      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('gradeName')">
              年级名称
              <span v-if="sortColumnKey === 'gradeName'">
                <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
              </span>
            </th>

            <th @click="sortColumn('schoolTermName')">
              学期名
              <span v-if="sortColumnKey === 'schoolTermName'">
                <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
              </span>
            </th>
            ...
            <th @click="sortColumn('submitStatusDesc')">
              送审状态
              <span v-if="sortColumnKey === 'submitStatusDesc'">
                <i :class="sortDirection === 'Asc' ? 'arrow-up' : 'arrow-down'"></i>
              </span>
            </th>
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            ...
            <td v-html="item.teachingPlanDesc"></td>

            <td v-html="item.gradeName"></td>

            <td v-html="item.schoolTermName"></td>

            <td v-html="item.courseName"></td>

            <td v-html="item.submitStatusDesc"></td>

            <td v-html="item.isClgCheck"></td>

            <td v-html="item.clgNote"></td>

            <td v-html="item.clgCheckDate"></td>

            <td v-html="item.isSchCheck"></td>

            <td v-html="item.schNote"></td>

            <td v-html="item.schCheckDate"></td>
