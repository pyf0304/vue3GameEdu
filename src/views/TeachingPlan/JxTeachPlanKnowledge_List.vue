      ...
      <table>
        <tbody>
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            <td>
              <input
                :id="'chk' + item.idTeachPlanKnowledge"
            ...
            <td v-html="item.idTeachPlanKnowledge"></td>

            <td v-html="item.idTeachingPlan"></td>
            ...
            <td v-html="item.assessmentMethodName"></td>

            <td v-html="item.knowledgeName"></td>

            <td v-html="item.teachingMethodName"></td>
