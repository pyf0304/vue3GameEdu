...
<script>
    ...
    function GetQuestionID() {
        ...
        Request = GetRequest();
        //const strQuestionId = Request['questionID'];
        ////传递的问题Id
        //$('#hidQuestionID').val(strQuestionId);

        const strExamBatchNo = Request['strExamBatchNo'];
        //const strQuestionTypeId = Request['strQuestionTypeId'];
        //const strQuestionNum = Request['strQuestionNum'];
        const strGameLevelId = Request['strGameLevelId'];
        const strHistory = Request['strHistory'];
        
        $('#hidIsHistory').val(strHistory);
        $('#hidExamBatchNo').val(strExamBatchNo);
    ...
    window.onload = function () {
        ...
        //传递临时ID；
        GetQuestionID();
        require(["../js/Web/OperationQuestionHistory.js"], function (index) {
            $('#indexTitle').html("操作题目");
            const objPage = new index.OperationQuestionHistory();
            objPage.PageLoad();

        });
        //通过参数判断是继续做题还是查看历史；
        const strHistory = $('#hidIsHistory').val();
        if (strHistory == "1") {
            //查看        
            //首次加载时候，运行按钮隐藏
            $('#submitBTN').hide();
        ...
        const iframe = document.getElementById("iframeResult").contentWindow.document.body.innerText = "";
    ...
    function ShowHtmlcode()
    {
        ...
        if ($("#ContentHtmlCode").val() != "") {
           // alert($("#ContentHtmlCode").val());
            //将输入框内的数据传给iframe
            //const iframe = document.getElementById("iframeResult").contentWindow.document.body.innerText = "";
            //const obj = window.frames["iframeResult"];
            //obj.document.body.innerHTML = "<div id='Test' style='display:none;'>" + $("#ContentHtmlCode").val() + "</div>";

           // const htmlCode = "<div id='Test' style='display:none;'>" + $("#ContentHtmlCode").val() + "</div>";
            const text = document.getElementById('ContentHtmlCode').value;
    ...
    function rundata() {
        ...
        //const content = document.getElementById("ContentHtmlCode");
      ...
      //  alert(text);
        ...
        if (text == "") {
            ...
            if ($("#ContentHtmlCode").val() != "") {
                ...
                const texthtml = document.getElementById('ContentHtmlCode').value;
            ...
            const strContentHtmlCode = $("#ContentHtmlCode").val();
    ...
    function Checkrundata() {
        ...
        //    else {
        //        //判断隐藏
        //        const ControlId = $("#hidControlID").val();//此ID是数据库中需要操作的标准ID
        ...
        //        const strid = $("#iframeResult").contents().find("#" + ControlId).attr("id");
        ...
        //        const ExaminationTypeId = $("#hidExaminationTypeId").val();
        //        const strResultType;
    ...
    function ShowPageList() {
        const RecCount = GetInputValueInDivObjN(divVarSet.refDivList, 'hidRecCount');
...
<div class="content">
    <div class="box1">
        <div class="title" style="height:45px;line-height:30px;padding-bottom:55px;">
            <div style="width:30%;float:left;margin-top:0px;height:30px;line-height:30px;">
            ...
            <div style="width:70%;margin-top:0px;height:30px;line-height:30px;float:right;">
        ...
        <div class="alert alert-success" style="min-height:310px;">
            <div style="float:left;width:49%;height:300px;overflow:auto">
                ...
                <label id="ContentHtmlText" style="float:left;color:dodgerblue;"></label>
            </div>
            @*<div style="float:right;width:50%;" id="Oldcode">
                    ...
                    <div style="float:left;width:100%;height:275px;">
                        ...
                        <textarea id="ContentHtmlCode" rows="12" cols="88" style="background-color:lightgray;margin-top:-35px;" disabled="disabled"></textarea>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        @*<form class="form-inline">
                                ...
                                <button id="btnMsg" type="button" class="btn btn-success" onclick="ShowMsgClick(this)" style="display:none;float:right;">帮助</button>
                            ...
                            <button id="QuestionAllSubmit" onclick="QuestionAllSubmit()" class="btn btn-success">全部提交</button>*@
                        ...
                        <button id="QuestionAllSubmit" onclick="QuestionAllSubmit()" class="btn btn-success" style="float:right;">全部提交</button>
                    </div>
                    <div class="panel-body">
                        ...
                        <div style="height:49%;width:100%;height:160px;overflow:auto;">
                            <table id="tabwucScore" name="tabwucScore" style="width: 100%; padding: 1px;" class="table table-bordered table-hover table td"></table>
...
<!-- 辨别是查看还是继续做题； -->
<input id="hidIsHistory" type="hidden" />
<!-- 关卡模式； -->
