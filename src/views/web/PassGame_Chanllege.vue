...
<script lang="ts">
  ...
  import { refDivLayout } from '@/views/web/PassGame_ChanllegeVueShare';

  export default defineComponent({
    name: 'PassGame_Chanllege',
    components: {
      // 组件注册
      StructureChartQuestionCom,
    },
    ...
    setup(props) {
      ...
      onMounted(() => {
        PassGame_Chanllege.divLayout = refDivLayout.value;
        PassGame_Chanllege.vuebtn_Click = btn_Click;
        PassGame_Chanllege.GetPropValue = GetPropValue;
      ...
      function btn_Click(strCommandName: string, strKeyId: string) {
        ...
        PassGame_Chanllege.btn_Click(strCommandName, strKeyId);
      }
      //展示习题信息
