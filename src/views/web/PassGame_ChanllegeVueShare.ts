...
export const passed_q = ref(true);
export const isSubmit_q = ref(true);
...
export const Combinege_UserCreditsLogCondition = async (): Promise<string> => {
  ...
  try {
    ...
    if (examBatchNo_q.value != '') {
      strWhereCond += Format(
        " And {0} like '%{1}%'",
        clsge_UserCreditsLogEN.con_ExamBatchNo,
        examBatchNo_q.value,
      );
    }
    ...
    const strMsg: string = Format(
      '在组合查询条件(Combinege_UserCreditsLogCondition)时出错!请联系管理员!{0}',
      objException,
    );
    throw strMsg;
  }
...
export const Combinege_UserCreditsLogConditionObj = async (): Promise<clsge_UserCreditsLogEN> => {
  ...
  objge_UserCreditsLogCond.SetCondFldValue(
    clsge_UserCreditsLogEN.con_IdCurrEduCls,
    IdCurrEduCls_Session.value,
    '=',
  );
  objge_UserCreditsLogCond.SetCondFldValue(
    clsge_UserCreditsLogEN.con_CourseId,
  ...
  try {
    ...
    const strMsg: string = Format(
      '在组合查询条件对象(Combinege_UserCreditsLogConditionObj)时出错!请联系管理员!{0}',
      objException,
    );
    throw strMsg;
  }
 ...
 * @returns 条件串(strWhereCond)
 **/
export const Combinege_UserCreditsLogConditionObj4ExportExcel =
  async (): Promise<clsge_UserCreditsLogEN> => {
    //使条件串的初值为"1 = 1",以便在该串的后面用"and "添加其他条件,
    //例如 1 = 1 && UserName = '张三'
    let strWhereCond = ' 1 = 1 ';
    ...
    try {
      ...
      const strMsg: string = Format(
        '在组合导出Excel条件对象(Combinege_UserCreditsLogConditionObj4ExportExcel)时出错!请联系管理员!{0}',
        objException,
      );
      throw strMsg;
    }
