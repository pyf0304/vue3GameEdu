<template>
  <div id="divLayout_QuestionList" ref="refDivLayout">
    <div id="divQuestionQuery" class="div_query">
      <table
        id="tabEdit"
        style="width: 30%"
      ...
      >
        <tbody>
          <tr>
            ...
            <td class="text-left">
              <select id="ddlCourseChapterId_q" class="form-control" style="width: 200px"></select>
            </td>
            <td class="text-left">
    ...
    <div id="divQuestionList1" ref="refDivList" style="background-color: #fff">
      <div id="divPager" class="pager divQuestionPager"> </div>
      <div id="divQuestionDataLst"> </div>
    </div>
    <a
      id="backtop"
      class="back-top"
...
<script lang="ts">
  ...
  import { refDivList, refDivLayout } from '@/views/QuestionaireEdit/QuestionnaireVueShare';
  // import {
  //   refDivList as refDivList_Ttl,
  //   refDivLayout as refDivLayout_Ttl,
  // } from '@/views/GameLearn/ge_UserCreditsTtlVueShare';
  import { PassGame_QuestionList } from '@/views/web/PassGame_QuestionList';

  export default defineComponent({
    name: 'PassGame_QuestionList',
    components: {
      // 组件注册
    },
    props: {
    ...
    setup(props) {
      ...
      onMounted(() => {
        PassGame_QuestionList.vuebtn_Click = btn_Click;
        PassGame_QuestionList.GetPropValue = GetPropValue;
        // refDivList_Ttl.value = refDivList.value;
        // refDivLayout_Ttl.value = refDivLayout.value;
        // const objPage = new PassGame_QuestionList();
        // objPage.PageLoad();
      });
      ...
      function btn_Click(strCommandName: string, strKeyId: string) {
        ...
        PassGame_QuestionList.btn_Click(strCommandName, strKeyId);
      }
      //展示习题信息
