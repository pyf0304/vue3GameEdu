      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('questionId')">
              题目Id
              <span>
                <i
                  :class="
                    sortColumnKey === 'questionId'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('questionCount')">
              回答人数
              <span>
                <i
                  :class="
                    sortColumnKey === 'questionCount'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('rightCount')">
              正确次数
              <span>
                <i
                  :class="
                    sortColumnKey === 'rightCount'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('errorCount')">
              错误次数
              <span>
                <i
                  :class="
                    sortColumnKey === 'errorCount'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('markCount')">
              打分数
              <span>
                <i
                  :class="
                    sortColumnKey === 'markCount'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('comment')">
              批注
              <span>
                <i
                  :class="
                    sortColumnKey === 'comment'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('difficultyLevelName|Ex')">
              难度
              <span>
                <i
                  :class="
                    sortColumnKey === 'difficultyLevelName|Ex'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            <td>
              <input
                :id="'chk' + item.idCurrEduCls + item.questionId"
            ...
            <td v-html="item.questionCount"></td>

            <td v-html="item.rightCount"></td>

            <td v-html="item.errorCount"></td>

            <td v-html="item.markCount"></td>

            <td v-html="item.comment"></td>

            <td v-html="item.updUser"></td>

            <td v-html="item.difficultyLevelName"></td>
