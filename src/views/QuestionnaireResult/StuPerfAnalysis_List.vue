      ...
      <table>
        <tbody>
          <tr class="text-primary">
            ...
            <th @click="sortColumn('askedCount')">
              提问数
              <span>
                <i
                  :class="
                    sortColumnKey === 'askedCount'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('commentCount')">
              评论数
              <span>
                <i
                  :class="
                    sortColumnKey === 'commentCount'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
            ...
            <th @click="sortColumn('totalPoints')">
              总积分
              <span>
                <i
                  :class="
                    sortColumnKey === 'totalPoints'
                      ? sortDirection === 'Asc'
                        ? 'arrow-up'
                        : 'arrow-down'
                      : 'arrow-neutral'
          ...
          <tr v-for="(item, index) in items" :key="index" class="text-secondary">
            <td>
              <input
                :id="'chk' + item.idStudentInfo + item.idCurrEduCls"
            ...
            <td v-html="item.askedCount"></td>

            <td v-html="item.commentCount"></td>

            <td v-html="item.likeCount"></td>

            <td v-html="item.totalPoints"></td>
