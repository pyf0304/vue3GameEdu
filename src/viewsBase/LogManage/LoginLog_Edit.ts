 ...
 **/
import $ from "jquery";
import { LoginLog_CheckPropertyNew,LoginLog_AddNewRecordAsync,LoginLog_GetUniCondStr,LoginLog_IsExistRecordAsync,LoginLog_GetUniCondStr4Update,LoginLog_AddNewRecordWithReturnKeyAsync,LoginLog_IsExistAsync,LoginLog_GetObjByLoginLogIdAsync,LoginLog_CheckProperty4Update,LoginLog_UpdateRecordAsync,LoginLog_EditRecordExAsync } from "@/ts/L3ForWApi/LogManage/clsLoginLogWApi";
import { clsLoginLogEN } from "@/ts/L0Entity/LogManage/clsLoginLogEN";
import { IsNullOrEmpty,Format } from "@/ts/PubFun/clsString";
import { LoginLog_DeleteKeyIdCache,divVarSet,refLoginLog_Edit } from "@/views/LogManage/LoginLogVueShare";
...
{
refLoginLog_Edit.value.hideDialog();
if (this.iShowList != null) this.iShowList.BindGvCache(clsLoginLogEN._CurrTabName, "");
}
}
else
{
...
if (this.iShowList != null) this.iShowList.BindGv(clsLoginLogEN._CurrTabName, this.keyId.toString());
}
}
break;
case "确认修改":
