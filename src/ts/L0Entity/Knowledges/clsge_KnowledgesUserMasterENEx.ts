...
export class  clsge_KnowledgesUserMasterENEx extends clsge_KnowledgesUserMasterEN
{
//以下是属性变量
...
//return propName in new clsge_KnowledgesUserMasterENEx();
const instance = new clsge_KnowledgesUserMasterENEx();
