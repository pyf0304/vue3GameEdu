...
export class  clscc_CourseExamPaperRelationshipEN extends clsGeneralTab
{
...
private mintTopicOrderNum = 0;    //TopicOrderNum
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
*/
 public SetTopicOrderNum (value: number)
{
if (value  != undefined)
{
 this.topicOrderNum = value;
    this.hmProperty["topicOrderNum"] = true;
   this.sfUpdFldSetStr = this.updFldString;
}
}
...
//return propName in new clscc_CourseExamPaperRelationshipEN();
const instance = new clscc_CourseExamPaperRelationshipEN();
