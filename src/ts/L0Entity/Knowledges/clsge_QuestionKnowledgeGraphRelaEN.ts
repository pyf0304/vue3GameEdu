...
export class  clsge_QuestionKnowledgeGraphRelaEN extends clsGeneralTab
{
...
break;
default:
strMsg = `字段名:[${strFldName}]在表对象:[ge_QuestionKnowledgeGraphRela]中不存在!(in ${this.constructor.name}.${strThisFuncName})`;
console.error(strMsg);
break;
}
}
...
const instance = new clsge_QuestionKnowledgeGraphRelaEN();
