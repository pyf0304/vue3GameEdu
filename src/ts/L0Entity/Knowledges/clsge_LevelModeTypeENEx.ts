...
export class  clsge_LevelModeTypeENEx extends clsge_LevelModeTypeEN
{
//以下是属性变量
...
//return propName in new clsge_LevelModeTypeENEx();
const instance = new clsge_LevelModeTypeENEx();
