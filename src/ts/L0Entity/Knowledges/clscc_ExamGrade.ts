...
switch (strFldName)
{
case clscc_ExamGrade.con_ExamGradeId:
return this.examGradeId;
case clscc_ExamGrade.con_ExamGradeName:
return this.examGradeName;
case clscc_ExamGrade.con_Memo:
return this.memo;
default:
