...
export class  clsge_GameLevelEduClsRelaEN extends clsGeneralTab
{
...
//return propName in new clsge_GameLevelEduClsRelaEN();
const instance = new clsge_GameLevelEduClsRelaEN();
