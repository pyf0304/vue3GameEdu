...
export class  clsTeachingCaseResCaseTypeENEx extends clsTeachingCaseResCaseTypeEN
{
//以下是属性变量
...
const instance = new clsTeachingCaseResCaseTypeENEx();
