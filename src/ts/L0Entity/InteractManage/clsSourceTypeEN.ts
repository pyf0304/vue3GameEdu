...
export class  clsSourceTypeEN extends clsGeneralTab
{
...
private mstrSourceTypeName = "";    //来源类型名称
private mstrMemo = "";    //备注
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
*/
 public SetSourceTypeName (value: string)
{
if (value  != undefined)
{
...
const instance = new clsSourceTypeEN();
