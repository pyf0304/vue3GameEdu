 ...
 * 表名:ge_StuBatchQuesRela(01120001)
...
export class clsge_StuBatchQuesRelaENExV2 extends clsge_StuBatchQuesRelaENEx {
  //以下是属性变量
  options: any[] = [];
  questionnaire: clsQuestionnaireEN | null = null;
  /**
   * 构造函数
