 ...
 /**
 * 类名:clscc_WorkStuRelation
 * 表名:cc_WorkStuRelation(01120145)
 * 版本:2024.12.05.1(服务器:WIN-SRV103-116)
 * 日期:2024/12/05 10:25:30
 * 生成者:pyf
 工程名称:问卷调查(0112)
...
export class  clscc_WorkStuRelation 
{
...
switch (strFldName)
{
case clscc_WorkStuRelation.con_IdWorkStuRelation:
return this.idWorkStuRelation;
case clscc_WorkStuRelation.con_IdCurrEduCls:
return this.idCurrEduCls;
case clscc_WorkStuRelation.con_QuestionId:
return this.questionId;
case clscc_WorkStuRelation.con_Scores:
return this.scores;
case clscc_WorkStuRelation.con_SpecifyCompletionDate:
return this.specifyCompletionDate;
case clscc_WorkStuRelation.con_IdStudentInfo:
return this.idStudentInfo;
case clscc_WorkStuRelation.con_AnswerModeId:
return this.answerModeId;
case clscc_WorkStuRelation.con_AnswerOptionId:
return this.answerOptionId;
case clscc_WorkStuRelation.con_AnswerMultiOptions:
return this.answerMultiOptions;
case clscc_WorkStuRelation.con_AnswerBoolResult:
return this.answerBoolResult;
case clscc_WorkStuRelation.con_StuAnswerText:
return this.stuAnswerText;
case clscc_WorkStuRelation.con_IsPublish:
return this.isPublish;
case clscc_WorkStuRelation.con_IsLook:
return this.isLook;
case clscc_WorkStuRelation.con_IsSave:
return this.isSave;
case clscc_WorkStuRelation.con_IsSubmit:
return this.isSubmit;
case clscc_WorkStuRelation.con_ApplySendBackDate:
return this.applySendBackDate;
case clscc_WorkStuRelation.con_IsApplySendBack:
return this.isApplySendBack;
case clscc_WorkStuRelation.con_RealFinishDate:
return this.realFinishDate;
case clscc_WorkStuRelation.con_OperateTime:
return this.operateTime;
case clscc_WorkStuRelation.con_Score:
return this.score;
case clscc_WorkStuRelation.con_Comment:
return this.comment;
case clscc_WorkStuRelation.con_IsMarking:
return this.isMarking;
case clscc_WorkStuRelation.con_MarkerId:
return this.markerId;
case clscc_WorkStuRelation.con_MarkDate:
return this.markDate;
case clscc_WorkStuRelation.con_IsSendBack:
return this.isSendBack;
case clscc_WorkStuRelation.con_IsInErrorQuestion:
return this.isInErrorQuestion;
case clscc_WorkStuRelation.con_WorkTypeId:
return this.workTypeId;
case clscc_WorkStuRelation.con_AnswerIP:
return this.answerIP;
case clscc_WorkStuRelation.con_AnswerDate:
return this.answerDate;
case clscc_WorkStuRelation.con_AnswerTime:
return this.answerTime;
case clscc_WorkStuRelation.con_CourseExamPaperId:
return this.courseExamPaperId;
case clscc_WorkStuRelation.con_IsRight:
return this.isRight;
case clscc_WorkStuRelation.con_IsAccessKnowledge:
return this.isAccessKnowledge;
case clscc_WorkStuRelation.con_IsNotProcessTimeout:
return this.isNotProcessTimeout;
case clscc_WorkStuRelation.con_SchoolYear:
return this.schoolYear;
case clscc_WorkStuRelation.con_SchoolTerm:
return this.schoolTerm;
case clscc_WorkStuRelation.con_ErrMsg:
return this.errMsg;
case clscc_WorkStuRelation.con_CourseId:
return this.courseId;
case clscc_WorkStuRelation.con_UpdDate:
return this.updDate;
case clscc_WorkStuRelation.con_UpdUserId:
return this.updUserId;
case clscc_WorkStuRelation.con_Memo:
return this.memo;
default:
