...
export class  clscc_ExamPaperStuRelation 
{
...
switch (strFldName)
{
case clscc_ExamPaperStuRelation.con_IdExamPaperStuRelation:
return this.idExamPaperStuRelation;
case clscc_ExamPaperStuRelation.con_CourseExamPaperId:
return this.courseExamPaperId;
case clscc_ExamPaperStuRelation.con_IdCurrEduCls:
return this.idCurrEduCls;
case clscc_ExamPaperStuRelation.con_Scores:
return this.scores;
case clscc_ExamPaperStuRelation.con_SpecifyCompletionDate:
return this.specifyCompletionDate;
case clscc_ExamPaperStuRelation.con_IdStudentInfo:
return this.idStudentInfo;
case clscc_ExamPaperStuRelation.con_AnswerModeId:
return this.answerModeId;
case clscc_ExamPaperStuRelation.con_AnswerOptionId:
return this.answerOptionId;
case clscc_ExamPaperStuRelation.con_AnswerMultiOptions:
return this.answerMultiOptions;
case clscc_ExamPaperStuRelation.con_StuAnswerText:
return this.stuAnswerText;
case clscc_ExamPaperStuRelation.con_IsPublish:
return this.isPublish;
case clscc_ExamPaperStuRelation.con_IsLook:
return this.isLook;
case clscc_ExamPaperStuRelation.con_IsSave:
return this.isSave;
case clscc_ExamPaperStuRelation.con_IsSubmit:
return this.isSubmit;
case clscc_ExamPaperStuRelation.con_ApplySendBackDate:
return this.applySendBackDate;
case clscc_ExamPaperStuRelation.con_IsApplySendBack:
return this.isApplySendBack;
case clscc_ExamPaperStuRelation.con_RealFinishDate:
return this.realFinishDate;
case clscc_ExamPaperStuRelation.con_OperateTime:
return this.operateTime;
case clscc_ExamPaperStuRelation.con_Score:
return this.score;
case clscc_ExamPaperStuRelation.con_Comment:
return this.comment;
case clscc_ExamPaperStuRelation.con_IsMarking:
return this.isMarking;
case clscc_ExamPaperStuRelation.con_MarkerId:
return this.markerId;
case clscc_ExamPaperStuRelation.con_MarkDate:
return this.markDate;
case clscc_ExamPaperStuRelation.con_IsSendBack:
return this.isSendBack;
case clscc_ExamPaperStuRelation.con_IsInErrorQuestion:
return this.isInErrorQuestion;
case clscc_ExamPaperStuRelation.con_WorkTypeId:
return this.workTypeId;
case clscc_ExamPaperStuRelation.con_AnswerIP:
return this.answerIP;
case clscc_ExamPaperStuRelation.con_AnswerDate:
return this.answerDate;
case clscc_ExamPaperStuRelation.con_AnswerTime:
return this.answerTime;
case clscc_ExamPaperStuRelation.con_IsRight:
return this.isRight;
case clscc_ExamPaperStuRelation.con_IsAccessKnowledge:
return this.isAccessKnowledge;
case clscc_ExamPaperStuRelation.con_IsNotProcessTimeout:
return this.isNotProcessTimeout;
case clscc_ExamPaperStuRelation.con_SchoolYear:
return this.schoolYear;
case clscc_ExamPaperStuRelation.con_SchoolTerm:
return this.schoolTerm;
case clscc_ExamPaperStuRelation.con_UpdDate:
return this.updDate;
case clscc_ExamPaperStuRelation.con_UpdUserId:
return this.updUserId;
case clscc_ExamPaperStuRelation.con_Memo:
return this.memo;
default:
