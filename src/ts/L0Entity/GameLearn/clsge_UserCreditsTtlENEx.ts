...
export class  clsge_UserCreditsTtlENEx extends clsge_UserCreditsTtlEN
{
//以下是属性变量
 ...
 * (AutoGCLib.EntityLayerEx4TypeScript:Gen_ENEx_PropertyNameConst)
 */
 public static get con_GameNum(): string {return "gameNum";}    //闯关数

public userName = "";    //用户名
public courseId = "";    //课程Id
public eduClsName = "";    //教学班名
public gameNum = 0;    //闯关数
...
break;
case clsge_UserCreditsTtlENEx.con_GameNum:
this.gameNum = Number(strValue);
    this.hmProperty["gameNum"] = true;
break;
case "sfUpdFldSetStr":
...
//return propName in new clsge_UserCreditsTtlENEx();
const instance = new clsge_UserCreditsTtlENEx();
