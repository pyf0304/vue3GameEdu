...
export class  clsBadgeCategoryENEx extends clsBadgeCategoryEN
{
//以下是属性变量
...
//return propName in new clsBadgeCategoryENEx();
const instance = new clsBadgeCategoryENEx();
