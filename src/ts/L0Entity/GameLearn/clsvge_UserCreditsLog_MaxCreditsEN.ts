...
export class  clsvge_UserCreditsLog_MaxCreditsEN extends clsGeneralTabV
{
...
//return propName in new clsvge_UserCreditsLog_MaxCreditsEN();
const instance = new clsvge_UserCreditsLog_MaxCreditsEN();
