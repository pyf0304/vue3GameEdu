...
export class  clsge_ControlTypeEN extends clsGeneralTab
{
...
private mstrControlTypeName = "";    //控件名称
private mstrControlTypeEnName = "";    //控件英文名称
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
*/
 public SetControlTypeName (value: string)
{
if (value  != undefined)
{
 this.controlTypeName = value;
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
*/
 public SetControlTypeEnName (value: string)
{
if (value  != undefined)
{
 this.controlTypeEnName = value;
    this.hmProperty["controlTypeEnName"] = true;
   this.sfUpdFldSetStr = this.updFldString;
}
}
...
break;
case clsge_ControlTypeEN.con_ControlTypeEnName:
this.controlTypeEnName = strValue;
    this.hmProperty["controlTypeEnName"] = true;
break;
case clsge_ControlTypeEN.con_UpdDate:
...
break;
default:
strMsg = `字段名:[${strFldName}]在表对象:[ge_ControlType]中不存在!(in ${this.constructor.name}.${strThisFuncName})`;
console.error(strMsg);
break;
}
}
...
//return propName in new clsge_ControlTypeEN();
const instance = new clsge_ControlTypeEN();
