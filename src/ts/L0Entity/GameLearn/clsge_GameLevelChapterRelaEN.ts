...
export class  clsge_GameLevelChapterRelaEN extends clsGeneralTab
{
...
//return propName in new clsge_GameLevelChapterRelaEN();
const instance = new clsge_GameLevelChapterRelaEN();
