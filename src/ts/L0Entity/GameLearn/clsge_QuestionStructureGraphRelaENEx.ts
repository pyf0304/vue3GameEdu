...
export class  clsge_QuestionStructureGraphRelaENEx extends clsge_QuestionStructureGraphRelaEN
{
//以下是属性变量
...
const instance = new clsge_QuestionStructureGraphRelaENEx();
