 ...
 /**
 * 类名:clsge_ExaminationTypeENEx
 * 表名:ge_ExaminationType(01120902)
 * 版本:2024.12.05.1(服务器:WIN-SRV103-116)
 * 日期:2024/12/05 10:26:18
 * 生成者:pyf
 工程名称:问卷调查(0112)
...
export class  clsge_ExaminationTypeENEx extends clsge_ExaminationTypeEN
{
//以下是属性变量
...
const instance = new clsge_ExaminationTypeENEx();
