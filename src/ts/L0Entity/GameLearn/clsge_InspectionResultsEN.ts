...
export class  clsge_InspectionResultsEN extends clsGeneralTab
{
...
private mstrInspectionName = "";    //检查名称
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
*/
 public SetInspectionName (value: string)
{
if (value  != undefined)
{
 this.inspectionName = value;
    this.hmProperty["inspectionName"] = true;
   this.sfUpdFldSetStr = this.updFldString;
}
}
...
//return propName in new clsge_InspectionResultsEN();
const instance = new clsge_InspectionResultsEN();
