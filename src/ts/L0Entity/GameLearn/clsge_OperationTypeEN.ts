...
export class  clsge_OperationTypeEN extends clsGeneralTab
{
...
private mstrOperationTypeEnName = "";    //OperationTypeEnName
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
*/
 public SetOperationTypeEnName (value: string)
{
if (value  != undefined)
{
 this.operationTypeEnName = value;
    this.hmProperty["operationTypeEnName"] = true;
   this.sfUpdFldSetStr = this.updFldString;
}
}
...
break;
case clsge_OperationTypeEN.con_OperationTypeEnName:
this.operationTypeEnName = strValue;
    this.hmProperty["operationTypeEnName"] = true;
break;
case clsge_OperationTypeEN.con_UpdUser:
...
break;
default:
strMsg = `字段名:[${strFldName}]在表对象:[ge_OperationType]中不存在!(in ${this.constructor.name}.${strThisFuncName})`;
console.error(strMsg);
break;
}
}
...
//return propName in new clsge_OperationTypeEN();
const instance = new clsge_OperationTypeEN();
