 ...
 /**
 * 类名:clsQuestionSourceENEx
 * 表名:QuestionSource(01120991)
 * 版本:2025.01.04.1(服务器:WIN-SRV103-116)
 * 日期:2025/02/10 23:07:54
 * 生成者:pyf
 工程名称:问卷调查(0112)
...
export class  clsQuestionSourceENEx extends clsQuestionSourceEN
{
//以下是属性变量
...
//return propName in new clsQuestionSourceENEx();
const instance = new clsQuestionSourceENEx();
