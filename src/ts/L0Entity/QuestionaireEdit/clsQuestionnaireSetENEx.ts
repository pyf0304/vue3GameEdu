...
export class  clsQuestionnaireSetENEx extends clsQuestionnaireSetEN
{
//以下是属性变量
...
//return propName in new clsQuestionnaireSetENEx();
const instance = new clsQuestionnaireSetENEx();
