...
export class  clsRecommendedDegree 
{
...
switch (strFldName)
{
case clsRecommendedDegree.con_RecommendedDegreeId:
return this.recommendedDegreeId;
case clsRecommendedDegree.con_RecommendedDegreeName:
return this.recommendedDegreeName;
case clsRecommendedDegree.con_Memo:
return this.memo;
default:
