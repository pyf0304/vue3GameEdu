...
export class  clsAnswerTypeEN extends clsGeneralTab
{
...
private mstrAnswerTypeName = "";    //答案类型名
private mstrAnswerTypeENName = "";    //答案类型英文名
private mstrMemo = "";    //备注
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
*/
 public SetAnswerTypeName (value: string)
{
if (value  != undefined)
{
 this.answerTypeName = value;
    this.hmProperty["answerTypeName"] = true;
   this.sfUpdFldSetStr = this.updFldString;
}
}
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
*/
 public SetAnswerTypeENName (value: string)
{
if (value  != undefined)
{
 this.answerTypeENName = value;
    this.hmProperty["answerTypeENName"] = true;
   this.sfUpdFldSetStr = this.updFldString;
}
}
...
break;
case clsAnswerTypeEN.con_AnswerTypeENName:
this.answerTypeENName = strValue;
    this.hmProperty["answerTypeENName"] = true;
break;
case clsAnswerTypeEN.con_Memo:
this.memo = strValue;
...
break;
default:
strMsg = `字段名:[${strFldName}]在表对象:[AnswerType]中不存在!(in ${this.constructor.name}.${strThisFuncName})`;
console.error(strMsg);
break;
}
}
...
const instance = new clsAnswerTypeEN();
