...
export class  clsAnswerModeEN extends clsGeneralTab
{
...
private mstrAnswerModeName = "";    //答案模式名称
private mstrMemo = "";    //备注
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
*/
 public SetAnswerModeName (value: string)
{
if (value  != undefined)
{
 this.answerModeName = value;
...
const instance = new clsAnswerModeEN();
