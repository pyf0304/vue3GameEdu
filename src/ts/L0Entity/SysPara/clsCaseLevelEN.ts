...
export class  clsCaseLevelEN extends clsGeneralTab
{
...
private mstrCaseLevelName = "";    //案例等级名称
private mstrMemo = "";    //备注
 ...
 * (AutoGCLib.EntityLayer4TypeScript:Gen_EN_ClsProperty)
*/
 public SetCaseLevelName (value: string)
{
if (value  != undefined)
{
 this.caseLevelName = value;
    this.hmProperty["caseLevelName"] = true;
   this.sfUpdFldSetStr = this.updFldString;
}
}
...
const instance = new clsCaseLevelEN();
