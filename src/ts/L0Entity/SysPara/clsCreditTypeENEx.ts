...
export class  clsCreditTypeENEx extends clsCreditTypeEN
{
//以下是属性变量
...
//return propName in new clsCreditTypeENEx();
const instance = new clsCreditTypeENEx();
