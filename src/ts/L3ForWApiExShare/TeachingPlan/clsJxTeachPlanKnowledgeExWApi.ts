...
import {
  JxTeachPlanKnowledge_GetObjLstByPagerAsync,
...
export async function JxTeachPlanKnowledgeEx_GetObjExLstByPagerAsync(
  ...
  const arrJxTeachPlanKnowledgeObjLst = await JxTeachPlanKnowledge_GetObjLstByPagerAsync(
    objPagerPara,
  );
...
export async function JxTeachPlanKnowledgeEx_FuncMapAssessmentMethodName(
  ...
  try {
    ...
    const strMsg = Format(
      '(errid:Watl000937)函数映射表对象数据出错,{0}.(in {1}.{2})',
      e,
      jxTeachPlanKnowledgeEx_ConstructorName,
      strThisFuncName,
    );
...
export async function JxTeachPlanKnowledgeEx_FuncMapTeachingMethodName(
  ...
  try {
    ...
    const strMsg = Format(
      '(errid:Watl000938)函数映射表对象数据出错,{0}.(in {1}.{2})',
      e,
      jxTeachPlanKnowledgeEx_ConstructorName,
      strThisFuncName,
    );
...
export async function JxTeachPlanKnowledgeEx_FuncMapTeachingPlanDesc(
  ...
  try {
    ...
    const strMsg = Format(
      '(errid:Watl000939)函数映射表对象数据出错,{0}.(in {1}.{2})',
      e,
      jxTeachPlanKnowledgeEx_ConstructorName,
      strThisFuncName,
    );
...
export async function JxTeachPlanKnowledgeEx_FuncMapKeyAssessmentMethodName(
  ...
  try {
    ...
    const strMsg = Format(
      '(errid:Watl000940)函数映射表对象数据出错,{0}.(in {1}.{2})',
      e,
      jxTeachPlanKnowledgeEx_ConstructorName,
      strThisFuncName,
    );
...
export async function JxTeachPlanKnowledgeEx_FuncMapKeyTeachingMethodName(
  ...
  try {
    ...
    const strMsg = Format(
      '(errid:Watl000941)函数映射表对象数据出错,{0}.(in {1}.{2})',
      e,
      jxTeachPlanKnowledgeEx_ConstructorName,
      strThisFuncName,
    );
...
export async function JxTeachPlanKnowledgeEx_FuncMapKeyTeachingPlanDesc(
  ...
  try {
    ...
    const strMsg = Format(
      '(errid:Watl000942)函数映射表对象数据出错,{0}.(in {1}.{2})',
      e,
      jxTeachPlanKnowledgeEx_ConstructorName,
      strThisFuncName,
    );
