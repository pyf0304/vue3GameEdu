...
import { SysComment_GetObjLstByPagerAsync,SysComment_SortFunByKey } from "@/ts/L3ForWApi/GradEduTools/clsSysCommentWApi";
import { clsSysCommentEN } from "@/ts/L0Entity/GradEduTools/clsSysCommentEN";
import { Format,IsNullOrEmpty } from "@/ts/PubFun/clsString";
import { clsSysPara4WebApi } from "@/ts/PubConfig/clsSysPara4WebApi";
import { stuPagerPara } from "@/ts/PubFun/stuPagerPara";

export const sysCommentExController = "SysCommentExApi";
...
const arrSysCommentObjLst = await SysComment_GetObjLstByPagerAsync(objPagerPara);
