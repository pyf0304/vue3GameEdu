...
import { cc_ExamPaperType_GetObjLstCache,cc_ExamPaperType_GetObjLstByPagerAsync,cc_ExamPaperType_SortFunByKey } from "@/ts/L3ForWApi/SysPara/clscc_ExamPaperTypeWApi";
 ...
 **/
export  function cc_ExamPaperTypeEx_CopyToEx(objcc_ExamPaperTypeENS:clscc_ExamPaperTypeEN ): clscc_ExamPaperTypeENEx
{
...
{
const strMsg = Format("(errid:Watl000067)Copy表对象数据出错,{0}.(in {1}.{2})", e, cc_ExamPaperTypeEx_ConstructorName, strThisFuncName);
 ...
 * @returns 对象列表
*/
export  async function cc_ExamPaperTypeEx_GetObjExLstByPagerCache(objPagerPara: stuPagerPara ):Promise<Array<clscc_ExamPaperTypeENEx>> {
...
const arrcc_ExamPaperTypeExObjLst = arrcc_ExamPaperTypeObjLst.map(cc_ExamPaperTypeEx_CopyToEx);
 ...
 if (IsNullOrEmpty(objSortInfo.SortFld) == false && clscc_ExamPaperTypeEN.AttributeName.indexOf(objSortInfo.SortFld) == -1)
 {
 for (const objInFor of arrcc_ExamPaperTypeExObjLst) {
await cc_ExamPaperTypeEx_FuncMapByFldName(objSortInfo.SortFld, objInFor);
 }
 }
...
const objcc_ExamPaperTypeCond = new clscc_ExamPaperTypeENEx();
...
arrcc_ExamPaperTypeSel = arrcc_ExamPaperTypeSel.sort(cc_ExamPaperTypeEx_SortFunByKey(strSortFld, strSortType));
}
else {
...
const strMsg = Format("错误:[{0}]. \n根据条件:[{1}]获取分页对象列表不成功!(In {2}.{3})", e, objPagerPara.whereCond, cc_ExamPaperTypeEx_ConstructorName, strThisFuncName);
console.error(strMsg);
 ...
 * @returns 对象列表
*/
export  async function cc_ExamPaperTypeEx_GetObjExLstByPagerAsync(objPagerPara: stuPagerPara):Promise<Array<clscc_ExamPaperTypeENEx>> {
...
*/
export  function cc_ExamPaperTypeEx_FuncMapByFldName(strFldName: string, objcc_ExamPaperTypeEx: clscc_ExamPaperTypeENEx)
{
