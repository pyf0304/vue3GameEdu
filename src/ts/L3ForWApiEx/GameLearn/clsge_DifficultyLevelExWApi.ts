 ...
 * @returns 对象列表
 */
export async function ge_DifficultyLevelEx_GetObjExLstByPagerCache(
  ...
  const objge_DifficultyLevel_Cond = new clsge_DifficultyLevelENEx();
  ObjectAssign(objge_DifficultyLevel_Cond, obj_Cond);
  ...
  try {
    ...
    for (const strKey of sstrKeys) {
      ...
      arrge_DifficultyLevel_Sel = arrge_DifficultyLevel_Sel.filter(
    ...
    if (arrge_DifficultyLevel_Sel.length == 0) return arrge_DifficultyLevel_Sel;
